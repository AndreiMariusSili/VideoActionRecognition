from prepro.smth._augment_meta import main as augment_meta
from prepro.smth._create_dummy_set import main as create_dummy_set
from prepro.smth._extract_jpeg import main as extract_jpeg
