...
SMTH_ROOT_DIR = pl.Path(os.path.join(ROOT, 'data', SETTING, 'smth'))
SMTH_META_DIR = pl.Path(os.path.join(ROOT, 'data', SETTING, 'smth', 'meta'))
...
SMTH_GROUP2GID = pl.Path(os.path.join(ROOT, 'data', SETTING, 'smth', 'meta', 'group2gid.json'))
...
SMTH_READ_JPEG = len(list(SMTH_JPEG_DIR.glob('*.jpeg'))) > 0
