...
class I3DDecoder(nn.Module):
    def __init__(self, latent_size: int, name: str = 'i3d_encoder'):
        ...
        self.up_1x7x7 = mc.Upsample((1, 7, 7))
        ...
        # 832 x 1 x 7 x 7
        self.up_1x14x14 = mc.Upsample((1, 14, 14))
        # 832 x 1 x 14 x 14
        ...
        # 480 x 2 x 14 x 14
        self.up_2x28x28 = mc.Upsample((2, 28, 28))
        # 480 x 2 x 28 x 28
        ...
        # 192 x 2 x 28 x 28
        self.up_2x56x56 = mc.Upsample((2, 56, 56))
        # 192 x 2 x 56 x 56
        ...
        # 64 x 2 x 56 x 56
        self.up_4x112x112 = mc.Upsample((4, 112, 112))
        # 64 x 4 x 112 x 112
        ...
        # 3 x 4 x 112 x 112
        self.up_4x224x224 = mc.Upsample((4, 224, 224))
        # 3 x 4 x 224 x 224
