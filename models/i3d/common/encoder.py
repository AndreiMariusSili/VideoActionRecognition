...
class I3DEncoder(nn.Module):
    def __init__(self, embed_size: tp.Optional[int], name: str = 'i3d_encoder'):
        ...
        # 64 x 2 x 112 x 112
        self.maxPool3d_2a_3x3 = ib.MaxPool3dTFPadding(kernel_size=(1, 3, 3), stride=(1, 2, 2))
        # 64 x 2 x 56 x 56
        ...
        # 192 x 2 x 56 x 56
        self.maxPool3d_3a_3x3 = ib.MaxPool3dTFPadding(kernel_size=(1, 3, 3), stride=(1, 2, 2))
        # 192 x 2 x 28 x 28
        self.mixed_3b = ib.Mixed(192, [64, 96, 128, 16, 32, 32])
        # 256 x 2 x 28 x 28
        self.mixed_3c = ib.Mixed(256, [128, 128, 192, 32, 96, 64])
        # 480 x 2 x 28 x 28
        self.maxPool3d_4a_3x3 = ib.MaxPool3dTFPadding(kernel_size=(2, 3, 3), stride=(2, 2, 2))
        # 480 x 1 x 14 x 14
        self.mixed_4b = ib.Mixed(480, [192, 96, 208, 16, 48, 64], [1, 1, 1, 1, 1, 1, 1])
        # 512 x 1 x 14 x 14
        self.mixed_4c = ib.Mixed(512, [160, 112, 224, 24, 64, 64], [1, 1, 1, 1, 1, 1, 1])
        # 512 x 1 x 14 x 14
        self.mixed_4d = ib.Mixed(512, [128, 128, 256, 24, 64, 64], [1, 1, 1, 1, 1, 1, 1])
        # 512 x 1 x 14 x 14
        self.mixed_4e = ib.Mixed(512, [112, 144, 288, 32, 64, 64], [1, 1, 1, 1, 1, 1, 1])
        # 528 x 1 x 14 x 14
        self.mixed_4f = ib.Mixed(528, [256, 160, 320, 32, 128, 128], [1, 1, 1, 1, 1, 1, 1])
        # 832 x 1 x 14 x 14
        self.maxPool3d_5a_2x2 = ib.MaxPool3dTFPadding(kernel_size=(1, 2, 2), stride=(2, 2, 2))
        # 832 x 1 x 7 x 7
        self.mixed_5b = ib.Mixed(832, [256, 160, 320, 32, 128, 128], [1, 1, 1, 1, 1, 1, 1])
        # 832 x 1 x 7 x 7
        self.mixed_5c = ib.Mixed(832, [384, 192, 384, 48, 128, 128], [1, 1, 1, 1, 1, 1, 1])
        # 1024 x 1 x 7 x 7
        if self.embed_size:
            opts = mo.Unit3DOptions(out_channels=self.embed_size, in_channels=1024, kernel_size=(1, 1, 1),
                                    stride=(1, 1, 1), activation='none', padding='VALID', use_bias=False, use_bn=False)
